...
<table>
      ...
      <tr>
        ...
        <td><a href="https://github.com/gialucia">Gia Finocchiaro</a>
          <p><strong>Title:</strong> Study Abroad: Florence, Italy</p>
          <p><strong>Description:</strong>  I plan to create a website that will show and explain the city of Florence. I want to show all Florence has to offer to students studying abroad. I want to focus on the history and famous sites, food, clubs and much more.</p>
          <p><strong>Status:</strong> Approved </p>
      ...
      <tr>
        ...
        <td><a href="https://github.com/giselleblanco">Giselle Blanco</a>
          <p><strong>Title:</strong> An American in  Paris</p>
          <p><strong>Description:</strong> I just  spent the Fall Semester in Paris. I could share my explorations specifically in  Paris, and also across all Europe (London, Cannes, Florence, Barcelona,  Amsterdam, Berlin, Prague, Brussels, Zurich) as I took a lot of weekend trips!  I could pair it with pictures, and must see sites, and good eats!</p>
          <p><strong>Status:</strong> Approved</p>
        </td>
      </tr>
      <tr>
        ...
        <td><a href="https://github.com/isauregastinne">Isaure Gastinne</a>
          <p><strong>Title:</strong> Green Club  Website</p>
          <p> <strong>Description:</strong> Manhattan  College green club works with an association and try to develop awareness about  sustainability. They also implement concrete actions which will be presented in  this website, like rooftop gardening on Manhattan college's roof, bicycling,  vegetables and fruit sells, events, and awareness campaign for sustainability.</p>
          <p><strong>Status:</strong> Approved</p>
<a href="https://github.com/isauregastinne"> </a></td>
      ...
      <tr>
        ...
        <td><a href="https://github.com/jamesoconnor1993">James O'Connor</a>
          <p><strong>Title:</strong> The Land of  Westeros and its Families</p>
      ...
      <tr>
        ...
        <td><a href="https://github.com/kaylarichardson">Kayla Richardson</a>
          <p><strong>Title:</strong> Simple Arts &amp; Crafts </p>
          <p><strong>Description:</strong> This site  will show simple arts &amp; crafts projects. &nbsp;There will be step by step  instructions for craft projects that will be easy for anyone to do. &nbsp;It  will provide a variety of crafts such as customizing t-shirts, customizing  glass ware, and scrapbook ideas.</p>
          <p><strong>Status:</strong> Approved</p>
        </td>
      </tr>
      <tr>
